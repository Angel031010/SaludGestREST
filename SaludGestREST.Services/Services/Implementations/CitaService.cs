        ...
        public async Task<List<CitaReadDTO>> GetAllAsync()
        {
            var citas = await _context.Citas
                ...
                .Select(c => new CitaReadDTO
                {
                    ...
                    ApellidoPaternoPaciente = c.Paciente.ApPaterno,
                    ApellidoMaternoPaciente = c.Paciente.ApMaterno,
                    MedicoId = c.MedicoId,
                    MedicoNombre = c.Medico.Nombre,
                    ApellidoPaternoMedico = c.Medico.ApPaterno,
                    ApellidoMaternoMedico = c.Medico.ApMaterno,
